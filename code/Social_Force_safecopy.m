...
% Boundary Array %
%----------------%
%K==1 ist der Raum mit der Verengung in der Mitte
%Kreiert eine 2x2 Matrix mit "Grenzpunkten". Ein 2D Raum mit sochen Punkten
%parallell zur x-Achse auf höhe 6 und unten 3 und dann noch ein Doorway in
%der Mitte, mit 3:0.1:4 und 5:0.1:6 (Tor von 4-5)
%Schritten, Rechts konstant 3, dann wieder dasselbe nochmals aber rechts
%sechs, dann 
if (K == 1)
